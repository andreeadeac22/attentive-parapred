...
def simple_run(cdrs_train, lbls_train, masks_train, lengths_train, weights_template, weights_template_number,
    ...
    for epoch in range(epochs):
        ...
        probs_test1 = model(cdrs_test1, unpacked_masks_test1, masks_test1, list(lengths_test1))
        ...
        probs_test2 = probs_test1.data.cpu().numpy().astype('float32')
        lbls_test2 = lbls_test1.data.cpu().numpy().astype('int32')

        probs_test2 = flatten_with_lengths(probs_test2, list(lengths_test))
        lbls_test2 = flatten_with_lengths(lbls_test2, list(lengths_test))
