...
from epitope_attn import *

def epitope_run(epi_train, lbls_train, masks_train, lengths_train, weights_template, weights_template_number,
               epi_test, lbls_test, masks_test, lengths_test):

    print("epitope run", file=print_file)
    #model = EpitopePredict()
    model = EpiAttn(256)
